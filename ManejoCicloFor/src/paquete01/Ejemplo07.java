...
public class Ejemplo07 {
    public static void main(String[] args) {
        ...
        System.out.printf("%s\n", mensajeFinal);
        // tenemos un ciclo dentro de otro ciclo donde la variable i es el numero de la tabla y la variable contador solo sera el valor que nos ayude con cada operaciuon
    }
}
